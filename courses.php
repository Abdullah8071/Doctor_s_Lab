            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="course-1-item">
                <figure class="thumnail">
                  <a href="course-single.php?id=<?php echo $id ?>"><img style="width: 100%; height: 250px; object-fit: cover;" src="admin/course_cover_images/<?php echo $id ?>/<?php echo $course_cover_image ?>" alt="<?php echo $row['course_cover_image']; ?>" class="img-fluid"></a>
                ...
                <div class="course-1-content pb-4">
                  ...
                  <p><a href="course-single.php?id=<?php echo $id ?>" class="btn btn-primary rounded-0 px-4">Course Details</a></p>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 form-group">
              <div class="alert alert-warning">
                ...
                <?php echo "<strong>No Courses To Show</strong> "; ?>
              </div>
            </div>
          </div>
        <?php }
