                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    <?php if (isset($_SESSION['ucdelmsg'])) { ?>
                                        <div class="alert alert-danger">
                                            <button type="button" class="close" data-dismiss="alert">×</button>
                                            <?php echo $_SESSION['ucdelmsg']; ?>
                                            <?php unset($_SESSION['ucdelmsg']);?>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
                                        ...
                                        <tbody>
                                            <?php $query = mysqli_query($con, "SELECT * FROM user_reg_courses, course, user WHERE (user_reg_courses.course_id = course.course_id) and (user_reg_courses.user_id = user.user_id)");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="Del.php?userid=<?php echo $row['user_id'] ?>&courseid=<?php echo $row['course_id'] ?>" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
                                                </tr>
                                            <?php $cnt = $cnt + 1;
                                                } ?>
                                    </table>
